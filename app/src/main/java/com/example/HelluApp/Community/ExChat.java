...
public class ExChat extends AppCompatActivity {
    EditText etName;
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imgRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(ExChat.this, "프로필 저장 완료", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent=new Intent(ExChat.this, ChatActivity.class);
                        startActivity(intent);
                        finish();
